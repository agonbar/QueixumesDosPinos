      ...
      if (filterPath(location.pathname) == filterPath(this.pathname) &&
        ...
        if ($target) {
          ...
          $(this).click(function() {
            ...
            topMenu.parent().attr('style', 'height:0px').removeClass(
              'in'); //Close navigation
...
**********************************************************************/
  ...
  *************************/
  ...
  jQuery('.price-column, .testimonial').bind('inview', function(event,
    visible) {
    if (visible == true) {
      jQuery(this).addClass("animated fadeInDown");
    } else {
...
function initializeMap() {
  var lat = '42.339140'; //Set your latitude.
  var lon = '-7.872633'; //Set your longitude.

  var centerLon = lon - 0.000;
